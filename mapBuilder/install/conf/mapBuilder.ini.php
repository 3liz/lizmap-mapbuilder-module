...
;; if you want the map builder to display only one repository, put its id here. Leave blank to get all repositories.
repository=

;; put here original extent (WGS 84) when mapBuilder load. Default is metropolitan France.
extent="-4.65,51.68,9.10,40.63"
