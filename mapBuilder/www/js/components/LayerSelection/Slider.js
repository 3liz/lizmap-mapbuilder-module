 ...
 * @property {HTMLDivElement} div The main slider container.
 * @property {HTMLDivElement} inDiv The thumb element inside the slider.
 */
export class Slider extends HTMLElement {

    /**
     * Create a slider for the layer opacity.
    ...
    constructor(style, layer) {
         ...
         * @returns {number} New position of the thumb.
         */
