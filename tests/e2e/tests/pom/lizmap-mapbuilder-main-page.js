exports.LizmapMapbuilderMainPage = class LizmapMapbuilderMainPage {
   ...
   *
   * @param {number} [index=-1] The index of the attribute layer tab to close (from left to right). If not specified
  ...
  /**
   * Retrieves a list of folder elements located in the layer store holder.
   */
  async getListFolder() {
   ...
   * @return {Locator} A locator pointing on the layer.
   */
   ...
   *
   * @return {Array<Locator>} Array of Locator pointing on each element.
   */
